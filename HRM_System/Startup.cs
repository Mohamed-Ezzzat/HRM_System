...
namespace HRM_System
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<UserManager<HRUser>>();
            ...
            services.AddScoped(typeof(IEntityRepository<>), typeof(EntityRepository<>));//Allow Dependency Injection
            services.AddScoped(typeof(UserManager<HRUser>));
